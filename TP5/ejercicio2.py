...
#minúsculas, otra con todas las letras mayúsculas y otra solo con la primera letra del nombre y de los 
#apellidos en mayúscula. El usuario puede introducir su nombre combinando mayúsculas y 
